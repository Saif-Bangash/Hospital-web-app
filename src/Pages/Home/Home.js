    ...
    <div className="container-fluid bg-light">
      <div className="row">
        ...
        <div className="col-md-6 mt-5">
          <div className="d-flex bg-white w-100 rounded">
            <div className="icon p-5">
              <img src="https://demo.dashboardpack.com/hospital-html/img/icon/man.svg"alt="doctor icon"/>
            </div>
            <div className="count_content pt-5">
              <h3><span><CountUp end={520} duration={5} /></span></h3>
        ...
        <div className="col-md-6 mt-5">
          <div className="d-flex bg-white w-100 rounded">
            <div className="icon p-5">
              <img src="https://demo.dashboardpack.com/hospital-html/img/icon/cap.svg"alt="doctor icon"/>
            </div>
            <div className="count_content pt-5">
               <h3><span><CountUp end={6969} duration={5} /></span></h3>
               <p style={{ color: "#B2B5C0", fontFamily: "Rajdhani, sans-serif" }}>Doctors</p>
            </div>
          </div>
        </div>
        <div className="col-md-6 mt-5">
          <div className="d-flex bg-white w-100 rounded">
            <div className="icon p-5">
              <img src="https://demo.dashboardpack.com/hospital-html/img/icon/wheel.svg" alt="doctor icon"/>
            </div>
            <div className="count_content pt-5">
              <h3><span><CountUp end={4054} duration={5} /></span></h3>
              <p style={{ color: "#B2B5C0", fontFamily: "Rajdhani, sans-serif" }}>Doctors</p>
            </div>
          </div>
        </div>
        <div className="col-md-6 mt-5">
          <div className="d-flex bg-white w-100 rounded">
            <div className="icon p-5">
              <img src="https://demo.dashboardpack.com/hospital-html/img/icon/pharma.svg"alt="doctor icon"/>
                </div>
                <div className="count_content pt-5">
                <h3><span><CountUp end={1139} duration={5} /></span></h3>
              <p style={{ color: "#B2B5C0", fontFamily: "Rajdhani, sans-serif" }}>Doctors</p>
            </div>
          </div>
        </div>
